...
impl Default for BasicParameters {
    fn default() -> Self {
        Self {
            char_coef: 0.32179011622983417,
            word_coef: 0.07005777134582551,
            avg_word_length_coef: 0.5090046481416842,
            space_coef: -0.15824193259426164,
            intercept: 1.5919160517260948,
        }
    }
}
