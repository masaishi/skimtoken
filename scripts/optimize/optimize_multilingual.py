...
from .utils import calculate_metrics, filter_outliers, load_dataset
...
def optimize_language_params(
    ...
    model = Ridge(alpha=2.0, fit_intercept=True, max_iter=10000)
...
def optimize_parameters(
    ...
    if val_path and val_path.exists():
        ...
        # Group validation data by detected language
        print("Detecting languages for validation samples...")
